...
static ForwardTransFunc for_trans[MAXPROJ + 1];/* forward function pointer array*/
static InverseTransFunc inv_trans[MAXPROJ + 1];/* inverse function pointer array*/
...
void
gctp(double *incoor, long int *insys, long int *inzone, double *inparm, long int *inunit, long int *indatum, long int *ipr, char *efile, long int *jpr, char *pfile, double *outcoor, long int *outsys, long int *outzone, double *outparm, long int *outunit, long int *outdatum, char *fn27, char *fn83, long int *iflg)

               		/* input coordinates				*/
            		/* input projection code			*/
             		/* input zone number				*/
               		/* input projection parameter array		*/
             		/* input units					*/
              		/* input datum 					*/
          		/* printout flag for error messages. 0=screen, 1=file,
			   2=both*/
            		/* error file name				*/
          		/* printout flag for projection parameters 0=screen, 
			   1=file, 2 = both*/
            		/* error file name				*/
                	/* output coordinates				*/
               		/* output datum					*/
             		/* output projection code			*/
              		/* output zone					*/
                	/* output projection array			*/
              		/* output units					*/
            		/* file name of NAD 1927 parameter file		*/
             	 	/* file name of NAD 1983 parameter file		*/
           		/* error flag					*/
{
