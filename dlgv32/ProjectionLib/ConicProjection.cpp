// ConicProjection.cpp: implementation of the ConicProjection class.
//
...
bool 
ConicProjection::operator==( const Projection& p ) const
{
  const ConicProjection* pRHS = dynamic_cast<const ConicProjection*>(&p);
  if ( NULL != pRHS )
  {
...
// toString override
string
ConicProjection::toString() const
{
...
// Projection functions
bool
ConicProjection::projectToGeo( double x, double y, 
...
bool 
ConicProjection::projectFromGeo( double latitude, double longitude,
