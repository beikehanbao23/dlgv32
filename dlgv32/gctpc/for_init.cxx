...
void
for_init(long int outsys, long int outzone, double *outparm, long int outdatum, char *fn27, char *fn83, long int *iflg, ForwardTransFunc for_trans[])

            		/* output system code				*/
             		/* output zone number				*/
                	/* output array of projection parameters	*/
              		/* output datum					*/
           		/* NAD 1927 parameter file			*/
           		/* NAD 1983 parameter file			*/
           		/* status flag					*/
...
double paksz(double ang, long int *iflg);		/* function to convert DMS to DEG		*/
...
-----------------------------------*/
  ...
  if (outsys == SPCS)
    ...
    -------------------------------------------*/
    *iflg = stplnforint(outzone,outdatum,fn27,fn83);
    if (*iflg != 0)
       return;
