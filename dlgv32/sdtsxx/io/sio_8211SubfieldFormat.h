...
public:
   ...
   */
   type getType() const;
	...
	/// XXX kludge to get around VC++ 5.0 template instantiation
	bool operator<( sio_8211SubfieldFormat const& rhs ) const { return false; }
	...
	/// XXX kludge to get around VC++ 5.0 template instantiation
	bool operator!=( sio_8211SubfieldFormat const& rhs ) const { return true; }

private:

	/// XXX implementation is fully insulated
	sio_8211SubfieldFormatImp*  _imp;
