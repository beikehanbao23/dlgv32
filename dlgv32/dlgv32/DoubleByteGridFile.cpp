...
// Creation
bool DoubleByteGridFile::create( const CString& strFilename )
{
  // Open the data file
  ...
  d_hDataFileMapping = ::CreateFileMapping( d_hDataFile, NULL, PAGE_READONLY,
                                            0, 0, NULL );
  ...
  d_pDataFileBytes = (BYTE*)::MapViewOfFile( d_hDataFileMapping,
                                             FILE_MAP_READ, 0, 0, 0 );
