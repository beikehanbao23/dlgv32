...
void
inv_init(long int insys, long int inzone, double *inparm, long int indatum, char *fn27, char *fn83, long int *iflg, InverseTransFunc inv_trans[])

           		/* input system code				*/
            		/* input zone number				*/
               		/* input array of projection parameters		*/
             		/* input datum code				*/
...
-----------------------------------*/
  ...
  if (insys == SPCS)
     ...
     --------------------------------------------*/
     *iflg = stplninvint( inzone,indatum,fn27,fn83);
        if (*iflg != 0)
           return;
