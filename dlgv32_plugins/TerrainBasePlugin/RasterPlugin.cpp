...
static const char* g_strPluginName = "Terrain Base Data";
static const char* g_strMasks      = "*.bin";
...
bool loadOverlay( int layerID, const char* strFilename )
{
    ...
    RasterPluginLayer* pLayer = new TerrainBaseLayer( layerID, strFilename, (struct HINSTANCE__ *)g_hInstance );
