...
static void som_series(double *fb, double *fa2, double *fa4, double *fc1, double *fc3, double *dlam);
static double false_easting;
static double false_northing;

long
somforint(double r_major, double r_minor, long int satnum, long int path, double alf_in, double lon, double false_east, double false_north, double time, long int start1, long int flag)

               			/* major axis				*/
               			/* minor axis				*/
            			/* Landsat satellite number (1,2,3,4,5) */
          			/* Landsat path number */
