...
static const char* g_strPluginName = "USGS DEM";
static const char* g_strMasks      = "*.dem;*.1;*.2";
...
bool loadOverlay( int layerID, const char* strFilename )
{
    ...
    RasterPluginLayer* pLayer = new USGSDEMLayer( layerID, strFilename, (struct HINSTANCE__ *)g_hInstance );
