...
/* Initialize the Albers projection
  -------------------------------*/
long
alberinvint(double r_maj, double r_min, double lat1, double lat2, double lon0, double lat0, double false_east, double false_north)
...
double qsfnz(double eccent, double sinphi, double cosphi);			/* function to compute small q		*/
...
alberinv(double x, double y, double *lon, double *lat)
         			...
         			/* (O) Y projection coordinate 	*/
            			...
            			/* (I) Latitude 		*/
{
double qsfnz(double eccent, double sinphi, double cosphi);			/* function to calculate q	*/
...
double phi1z (double eccent, double qs, long int *flag);		/* function to calculate LAT phi	*/
